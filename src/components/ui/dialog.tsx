...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-2 opacity-70 ring-offset-background transition-opacity hover:opacity-100 hover:bg-[var(--surface)] focus:outline-none disabled:pointer-events-none data-[state=open]:bg-[var(--surface)] data-[state=open]:text-[var(--text-secondary)]">
